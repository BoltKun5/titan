...
import { ArrowBackIosNew, ArrowForwardIos, List } from '@mui/icons-material';
...
export const CardManagerFilterComponent: React.FC<{
  ...
  }, [cardSetFilter, nameFilter, page, rarityFilter, possessionFilter, order]);
  ...
  return !cardSetFilter ? (
    ...
    <>
      <div
        className={
          'CardManagerFilter' + (hidePagination ? ' hidePagination' : '')
        }
        style={
          hidePagination
            ? { maxWidth: 'calc(100vw - 20px)', position: 'relative' }
            : {}
        }
      >
        <div className="CardManagerFilter-top">
          <div
            className="CardManagerFilter-topElements"
            style={hidePagination ? { maxWidth: 'none' } : {}}
          >
            {
              <div
            ...
            {width > 550 && (
              <div
                className="CardManagerFilter-fixedWidthContainer"
                style={{ width: width > 700 ? 150 : 100, marginRight: 10 }}
              >
                <div
                ...
                >
                  <ButtonComponent
                    label={'Réinitialiser'}
                    size={width > 700 ? 150 : 100}
                    fontSize={width > 700 ? 20 : 13}
                    height={width > 700 ? 40 : 30}
                    clipPath={width > 700 ? 10 : 7}
                  />
                </div>
              </div>
            )}
          ...
          {pagination && !hidePagination && (
            <div className="CardManagerFilter-topPagination">
            ...
            >
              <div className="CardManagerFilter-bottom">
                <>
                  ...
                  {width <= 1430 && (
                    <div
                      className="CardManagerFilter-fixedWidthContainer CardManagerFilter-rarityFilterContainer"
                            ...
                            >
                              ...
                              >
                                <img
                                  className="CardManagerFilter-rarityImg"
                                  src={
                                    '/assets/icons/' + filter.rarity + '.png'
                                  }
                                />
                              </div>
                            </Tooltip>
