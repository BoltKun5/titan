...
import { ButtonComponentPropsType, SwipeCheckboxComponentType } from "../../../../../local-core";
import './style.scss';



export const SwipeCheckboxComponent: React.FC<SwipeCheckboxComponentType> = ({ label, value, width, elements, callback }) => {
    ...
    <div className="SwipeCheckboxComponent">
      ...
      <div className="SwipeCheckboxComponent-container">
        <div className="SwipeCheckboxComponent-elements">
          ...
          <div className="SwipeCheckboxComponent-activeElement" style={getSelectedElementBgStyle()} />
        </div>
      </div>
    </div>
  )
